...
(async () => {
  ...
  await p.addStyleTag({ content: '.bar,.rail,.soon,.notify,.pit-pops{display:none!important}.hero{min-height:630px!important;padding-top:0!important;padding-bottom:0!important;align-items:center}' });
